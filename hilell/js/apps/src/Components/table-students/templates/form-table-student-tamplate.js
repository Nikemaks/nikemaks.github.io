const tmpl = `
            <form action="" class="section-student__form">
                <div class="section-student__form-left">
                    <label for="firstName">First Name<input type="text" id="firstName" class="form-input"></label>
                    <label for="lastName">Last Name<input type="text" id="lastName" class="form-input"></label>
                    <label for="age">Age<input id="age" type="number" class="form-input"></label>
